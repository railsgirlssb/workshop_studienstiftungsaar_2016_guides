...
function initializeOsSwitchers() {
  $(".os-specific").append("<span class='picker'>Wähle dein Betriebssystem: <a href='#' class='win-link'>Windows</a> | <a href='#' class='nix-link'>Other</a></span>").find(".win-link").click(function(event) {
